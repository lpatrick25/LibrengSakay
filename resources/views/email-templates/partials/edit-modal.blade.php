...
<div class="modal fade" id="editTemplateModal" tabindex="-1" aria-labelledby="editTemplateModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form id="edit-template-form" novalidate>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fw-bold mb-1" id="edit-name">
                                                    —
                                                </h5>
                                        ...
                                        <div>
                                            ...
                                            <textarea id="edit-body" name="body" class="d-none">
                                            </textarea>

                                            <div id="editor-container" class="border rounded-3 overflow-hidden">
                                            </div>

                                            <div class="invalid-feedback d-block" data-error="body">
                                            </div>
                                ...
                                <div class="card border-0 shadow-sm rounded-4 sticky-top" style="top:1rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="small text-muted mb-3">
                                            ...
                                            subject or body. Click the copy
                                            button to insert them into your
                                            clipboard.
                ...
                <div class="modal-footer border-0 pt-0">
                    ...
                    <div class="ms-auto d-flex flex-wrap gap-2">
                        ...
                        <button type="button" id="btn-test-from-edit" class="btn btn-outline-info rounded-pill px-3">
